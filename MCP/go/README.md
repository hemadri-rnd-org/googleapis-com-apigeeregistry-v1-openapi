# Apigee Registry API MCP Server

This MCP (Model Content Protocol) server provides access to Apigee Registry API API functionality through HTTP, HTTPS, and STDIO transport modes.
