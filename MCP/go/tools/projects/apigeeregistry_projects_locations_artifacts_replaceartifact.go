...
func Apigeeregistry_projects_locations_artifacts_replaceartifactHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateApigeeregistry_projects_locations_artifacts_replaceartifactTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_v1_name",
		mcp.WithDescription("Used to replace a specified artifact."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Apigeeregistry_projects_locations_artifacts_replaceartifactHandler(cfg),
	}
}
